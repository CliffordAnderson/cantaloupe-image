...
ADD https://iiif-library-cantaloupe-configurationfiles.s3.amazonaws.com/cantaloupe_settings.txt /cantaloupe/settings.txt

RUN chown -R cantaloupe /cantaloupe/settings.txt
